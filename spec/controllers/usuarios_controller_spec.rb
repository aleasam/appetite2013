  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved usuario as @usuario" do
        ...
        post :create, {:usuario => { "nombre_completo" => "invalid value" }}, valid_session
        assigns(:usuario).should be_a_new(Usuario)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested usuario" do
        ...
        Usuario.any_instance.should_receive(:update_attributes).with({ "nombre_completo" => "MyString" })
        put :update, {:id => usuario.to_param, :usuario => { "nombre_completo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the usuario as @usuario" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Usuario.any_instance.stub(:save).and_return(false)
        put :update, {:id => usuario.to_param, :usuario => { "nombre_completo" => "invalid value" }}, valid_session
        assigns(:usuario).should eq(usuario)
      end
