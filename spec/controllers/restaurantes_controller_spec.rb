  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved restaurante as @restaurante" do
        ...
        post :create, {:restaurante => { "nombre" => "invalid value" }}, valid_session
        assigns(:restaurante).should be_a_new(Restaurante)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested restaurante" do
        ...
        Restaurante.any_instance.should_receive(:update_attributes).with({ "nombre" => "MyString" })
        put :update, {:id => restaurante.to_param, :restaurante => { "nombre" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the restaurante as @restaurante" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Restaurante.any_instance.stub(:save).and_return(false)
        put :update, {:id => restaurante.to_param, :restaurante => { "nombre" => "invalid value" }}, valid_session
        assigns(:restaurante).should eq(restaurante)
      end
